...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Hemachand S S
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">Creative and detail-oriented Software Developer in building scalable web applications.</p>
